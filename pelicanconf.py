...
META_KEYWORDS = 'วัดป่าโพธิญาณ, Wat Pah Photiyan, 菩提智叢林道場'
META_DESCRIPTION = 'วัดป่าโพธิญาณ, Wat Pah Photiyan, 菩提智叢林道場'
...
CONTENT_DIR_URL = u'https://github.com/siongui/wat-pah-photiyan/tree/master/content'
